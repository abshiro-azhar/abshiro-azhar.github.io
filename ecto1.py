...
class Downloader:
	def __init__(self, source_url_root, target_url_root):
		...
		self.target_path_root = pathlib.Path(os.getcwd()) / 'docs' #self.target_path_root = pathlib.Path(os.getcwd()) / 'public'
...
print('Done. Contents have been downloaded into:', pathlib.Path(os.getcwd()) / 'docs') #print('Done. Contents have been downloaded into:', pathlib.Path(os.getcwd()) / 'public')
